...
#TODO
    ...
    #TODO
    ending_names = [f"para{i}" for i in range(4)]
    ...
    def preprocess_function(examples):
        first_sentences = [[context] * 4 for context in examples[context_name]] #question
        #question_headers = examples[question_header_name]
        question_headers = "找出最適合的文章"
        ...
        if '' not in examples['relevant']:
            labels =[para.index(ind)
                for para, ind in zip(examples['paragraphs'], examples['relevant'])]
        #print("!!!!!!!!!!")
        #print(labels)
        #print("!!!!!!!!1")
        #print(examples)
        ...
        if '' not in examples['relevant']:
            ...
            tokenized_inputs["labels"] = [0] * len(examples['paragraphs'])
        ...
        for epoch in range(1):
            ...
            for step, batch in enumerate(eval_dataloader):
                ...
                for i in predictions:
                    output_json.append(i.item())
            print(output_json)
            
            data_name = 'test_new.json'
            with open(data_name, encoding="utf8") as f:
                data = json.load(f)

            for i in range(len(data)):
                data[i]['relevant'] = data[i]["paragraphs"][output_json[i]]
            
            with open("test_after_multichoice.json", "w", encoding="utf8") as outfile:
