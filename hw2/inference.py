...
def main():
    ...
    with accelerator.main_process_first():
        train_dataset = raw_datasets["train"].map(
            ...
            remove_columns=column_names, #do not remove id
...
# We need to recalculate our total training steps as the size of the training dataloader may have changed.
        ...
        for epoch in range(starting_epoch, args.num_train_epochs):
            ...
            if args.validation_file is not None:
                ...
                gen_kwargs = {
                    ...
                    "num_beams": args.num_beams,#generate stategy
                }
                    #"do_sample":True,
                    #"top_k":0,
                    #"top_p":0.93
                ...
                for step, batch in enumerate(eval_dataloader):
                    with torch.no_grad():
                        ...
                        for i in decoded_preds:
                            prediction_result.append({'title': i})
                        metric.add_batch(
                            predictions=decoded_preds,
                            references=decoded_labels,
                        )
                with open(os.path.join(args.output_dir, f"prediction{epoch}.json"), "w", encoding="utf-8") as f:
    ...
    if args.output_dir is not None:
        ...
        if accelerator.is_main_process:
            ...
            with open(os.path.join(args.output_dir, "prediction.json"), "w", encoding="utf-8") as f:
                json.dump(prediction_result, f, ensure_ascii = False)
